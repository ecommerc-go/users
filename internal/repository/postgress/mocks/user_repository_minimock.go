...
//go:generate minimock -i github.com/ecommerc-go/users/internal/repository/postgress.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
import (
	...
	mm_repository "github.com/ecommerc-go/users/internal/repository/postgress"
...
type UserRepositoryMock struct {
	...
	funcCreateUser          func(ctx context.Context, user *models.RegisterRequest) (s1 string, err error)
	funcCreateUserOrigin    string
	inspectFuncCreateUser   func(ctx context.Context, user *models.RegisterRequest)
	afterCreateUserCounter  uint64
	beforeCreateUserCounter uint64
	CreateUserMock          mUserRepositoryMockCreateUser

	funcDeleteUser          func(ctx context.Context, id string) (err error)
	funcDeleteUserOrigin    string
	inspectFuncDeleteUser   func(ctx context.Context, id string)
	afterDeleteUserCounter  uint64
	beforeDeleteUserCounter uint64
	DeleteUserMock          mUserRepositoryMockDeleteUser

	funcGetCredentials          func(ctx context.Context, email string) (cp1 *mm_repository.Creds, err error)
	funcGetCredentialsOrigin    string
	...
	funcGetUser          func(ctx context.Context, id string) (up1 *models.UserProfile, err error)
	funcGetUserOrigin    string
	inspectFuncGetUser   func(ctx context.Context, id string)
	afterGetUserCounter  uint64
	beforeGetUserCounter uint64
	GetUserMock          mUserRepositoryMockGetUser

	funcUpdateUser          func(ctx context.Context, user *models.UpdateProfileRequest) (i1 int64, err error)
	funcUpdateUserOrigin    string
	inspectFuncUpdateUser   func(ctx context.Context, user *models.UpdateProfileRequest)
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Expect(ctx context.Context, user *models.RegisterRequest) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) ExpectUserParam2(user *models.RegisterRequest) *mUserRepositoryMockCreateUser {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Inspect(f func(ctx context.Context, user *models.RegisterRequest)) *mUserRepositoryMockCreateUser {
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Return(s1 string, err error) *UserRepositoryMock {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
	...
	mmCreateUser.defaultExpectation.results = &UserRepositoryMockCreateUserResults{s1, err}
...
func (mmCreateUser *mUserRepositoryMockCreateUser) Set(f func(ctx context.Context, user *models.RegisterRequest) (s1 string, err error)) *UserRepositoryMock {
	if mmCreateUser.defaultExpectation != nil {
...
// Then helper
func (mmCreateUser *mUserRepositoryMockCreateUser) When(ctx context.Context, user *models.RegisterRequest) *UserRepositoryMockCreateUserExpectation {
	if mmCreateUser.mock.funcCreateUser != nil {
		mmCreateUser.mock.t.Fatalf("UserRepositoryMock.CreateUser mock is already set by Set")
	}
...
func (e *UserRepositoryMockCreateUserExpectation) Then(s1 string, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockCreateUserResults{s1, err}
	return e.mock
}
...
func (mmCreateUser *UserRepositoryMock) CreateUser(ctx context.Context, user *models.RegisterRequest) (s1 string, err error) {
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Expect(ctx context.Context, id string) *mUserRepositoryMockDeleteUser {
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) ExpectIdParam2(id string) *mUserRepositoryMockDeleteUser {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserRepositoryMock.DeleteUser mock is already set by Set")
	}
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Inspect(f func(ctx context.Context, id string)) *mUserRepositoryMockDeleteUser {
...
func (mmDeleteUser *mUserRepositoryMockDeleteUser) Set(f func(ctx context.Context, id string) (err error)) *UserRepositoryMock {
	if mmDeleteUser.defaultExpectation != nil {
...
// Then helper
func (mmDeleteUser *mUserRepositoryMockDeleteUser) When(ctx context.Context, id string) *UserRepositoryMockDeleteUserExpectation {
	if mmDeleteUser.mock.funcDeleteUser != nil {
		mmDeleteUser.mock.t.Fatalf("UserRepositoryMock.DeleteUser mock is already set by Set")
	}
...
func (mmDeleteUser *UserRepositoryMock) DeleteUser(ctx context.Context, id string) (err error) {
...
type UserRepositoryMockGetCredentialsExpectation struct {
	...
	expectationOrigins UserRepositoryMockGetCredentialsExpectationOrigins
...
type UserRepositoryMockGetCredentialsResults struct {
	cp1 *mm_repository.Creds
	err error
}

// UserRepositoryMockGetCredentialsOrigins contains origins of expectations of the UserRepository.GetCredentials
type UserRepositoryMockGetCredentialsExpectationOrigins struct {
	origin      string
	originCtx   string
	originEmail string
}
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) Expect(ctx context.Context, email string) *mUserRepositoryMockGetCredentials {
	...
	mmGetCredentials.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) ExpectCtxParam1(ctx context.Context) *mUserRepositoryMockGetCredentials {
	...
	mmGetCredentials.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) ExpectEmailParam2(email string) *mUserRepositoryMockGetCredentials {
	...
	mmGetCredentials.defaultExpectation.expectationOrigins.originEmail = minimock.CallerInfo(1)
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) Return(cp1 *mm_repository.Creds, err error) *UserRepositoryMock {
	if mmGetCredentials.mock.funcGetCredentials != nil {
		mmGetCredentials.mock.t.Fatalf("UserRepositoryMock.GetCredentials mock is already set by Set")
	}
	...
	mmGetCredentials.defaultExpectation.results = &UserRepositoryMockGetCredentialsResults{cp1, err}
	mmGetCredentials.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGetCredentials.mock
}

// Set uses given function f to mock the UserRepository.GetCredentials method
func (mmGetCredentials *mUserRepositoryMockGetCredentials) Set(f func(ctx context.Context, email string) (cp1 *mm_repository.Creds, err error)) *UserRepositoryMock {
	if mmGetCredentials.defaultExpectation != nil {
	...
	mmGetCredentials.mock.funcGetCredentialsOrigin = minimock.CallerInfo(1)
	return mmGetCredentials.mock
}
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) When(ctx context.Context, email string) *UserRepositoryMockGetCredentialsExpectation {
	...
	expectation := &UserRepositoryMockGetCredentialsExpectation{
		...
		expectationOrigins: UserRepositoryMockGetCredentialsExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (e *UserRepositoryMockGetCredentialsExpectation) Then(cp1 *mm_repository.Creds, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetCredentialsResults{cp1, err}
	return e.mock
}
...
func (mmGetCredentials *mUserRepositoryMockGetCredentials) Times(n uint64) *mUserRepositoryMockGetCredentials {
	...
	mmGetCredentials.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetCredentials
}
...
// GetCredentials implements mm_repository.UserRepository
func (mmGetCredentials *UserRepositoryMock) GetCredentials(ctx context.Context, email string) (cp1 *mm_repository.Creds, err error) {
	...
	if mmGetCredentials.GetCredentialsMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetCredentials.t.Errorf("UserRepositoryMock.GetCredentials got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetCredentials.GetCredentialsMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmGetCredentials.t.Errorf("UserRepositoryMock.GetCredentials got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetCredentials.GetCredentialsMock.defaultExpectation.expectationOrigins.originEmail, *mm_want_ptrs.email, mm_got.email, minimock.Diff(*mm_want_ptrs.email, mm_got.email))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetCredentials.t.Errorf("UserRepositoryMock.GetCredentials got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetCredentials.GetCredentialsMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *UserRepositoryMock) MinimockGetCredentialsInspect() {
	for _, e := range m.GetCredentialsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.GetCredentials at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetCredentialsMock.defaultExpectation != nil && afterGetCredentialsCounter < 1 {
		if m.GetCredentialsMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to UserRepositoryMock.GetCredentials at\n%s", m.GetCredentialsMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to UserRepositoryMock.GetCredentials at\n%s with params: %#v", m.GetCredentialsMock.defaultExpectation.expectationOrigins.origin, *m.GetCredentialsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetCredentials != nil && afterGetCredentialsCounter < 1 {
		m.t.Errorf("Expected call to UserRepositoryMock.GetCredentials at\n%s", m.funcGetCredentialsOrigin)
	}

	if !m.GetCredentialsMock.invocationsDone() && afterGetCredentialsCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.GetCredentials at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetCredentialsMock.expectedInvocations), m.GetCredentialsMock.expectedInvocationsOrigin, afterGetCredentialsCounter)
	}
}
...
func (mmGetUser *mUserRepositoryMockGetUser) Expect(ctx context.Context, id string) *mUserRepositoryMockGetUser {
...
func (mmGetUser *mUserRepositoryMockGetUser) ExpectIdParam2(id string) *mUserRepositoryMockGetUser {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserRepositoryMockGetUser) Inspect(f func(ctx context.Context, id string)) *mUserRepositoryMockGetUser {
...
func (mmGetUser *mUserRepositoryMockGetUser) Return(up1 *models.UserProfile, err error) *UserRepositoryMock {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
...
func (mmGetUser *mUserRepositoryMockGetUser) Set(f func(ctx context.Context, id string) (up1 *models.UserProfile, err error)) *UserRepositoryMock {
	if mmGetUser.defaultExpectation != nil {
...
// Then helper
func (mmGetUser *mUserRepositoryMockGetUser) When(ctx context.Context, id string) *UserRepositoryMockGetUserExpectation {
	if mmGetUser.mock.funcGetUser != nil {
		mmGetUser.mock.t.Fatalf("UserRepositoryMock.GetUser mock is already set by Set")
	}
...
func (e *UserRepositoryMockGetUserExpectation) Then(up1 *models.UserProfile, err error) *UserRepositoryMock {
...
func (mmGetUser *UserRepositoryMock) GetUser(ctx context.Context, id string) (up1 *models.UserProfile, err error) {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Expect(ctx context.Context, user *models.UpdateProfileRequest) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) ExpectUserParam2(user *models.UpdateProfileRequest) *mUserRepositoryMockUpdateUser {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Inspect(f func(ctx context.Context, user *models.UpdateProfileRequest)) *mUserRepositoryMockUpdateUser {
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Return(i1 int64, err error) *UserRepositoryMock {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
	...
	mmUpdateUser.defaultExpectation.results = &UserRepositoryMockUpdateUserResults{i1, err}
...
func (mmUpdateUser *mUserRepositoryMockUpdateUser) Set(f func(ctx context.Context, user *models.UpdateProfileRequest) (i1 int64, err error)) *UserRepositoryMock {
	if mmUpdateUser.defaultExpectation != nil {
...
// Then helper
func (mmUpdateUser *mUserRepositoryMockUpdateUser) When(ctx context.Context, user *models.UpdateProfileRequest) *UserRepositoryMockUpdateUserExpectation {
	if mmUpdateUser.mock.funcUpdateUser != nil {
		mmUpdateUser.mock.t.Fatalf("UserRepositoryMock.UpdateUser mock is already set by Set")
	}
...
func (e *UserRepositoryMockUpdateUserExpectation) Then(i1 int64, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockUpdateUserResults{i1, err}
	return e.mock
}
...
func (mmUpdateUser *UserRepositoryMock) UpdateUser(ctx context.Context, user *models.UpdateProfileRequest) (i1 int64, err error) {
